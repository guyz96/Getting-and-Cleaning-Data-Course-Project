...
# 2. Extracts only the measurementss on the mean and standard deviation for each measurement. 
...
# 4. Appropriately labels the data set with descriptife activity names.
